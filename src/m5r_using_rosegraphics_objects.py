...
#                1. attach_to 2. move_by 3.move_center_to
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                1. radius 2. center 3. fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            Pauses the window for a certain amount of seconds
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#             When you do not want the window to automatically close when done constructing
#
